...
I mostly code using C# but every now and then use JavaScript on client-side. Aside from that, I use several other tools including ASP.NET Core, Entity Framework Core, React.js, Microsoft Azure, PostgreSQL, MySQL.
