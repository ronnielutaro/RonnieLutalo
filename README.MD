### Hi there! 👋
I'm Ronnie, a Software Engineer & Computer Graphics (CG) Artist from Kampala, Uganda. Currently, I mostly work on Backend Services, Distributed Systems and the Cloud. Driven by a desire and constant curiosity about creating great products that fully empower the user from end to end, I often find myself working on Product Design and Frontend development from time to time. I believe great products that truly enhance humanity and bring joy to the world unlock many new possibilities. Outside that, I enjoy working on Computer Graphics (CG) involving 3D Art and Digital/Graphics Design during my spare time.
